---
description: Revisione dell’architettura. Usa questo comando per eseguire la revisione corrispondente.
argument-hint: [area del progetto o problema]
---

Usa la skill canonica `software-architecture-review` per il progetto corrente.
