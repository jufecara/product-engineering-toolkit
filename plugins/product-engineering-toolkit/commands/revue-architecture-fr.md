---
description: Revue d’architecture. Utilisez cette commande pour exécuter la revue correspondante.
argument-hint: [zone du projet ou préoccupation]
---

Utilisez la compétence canonique `software-architecture-review` pour le projet actuel.
