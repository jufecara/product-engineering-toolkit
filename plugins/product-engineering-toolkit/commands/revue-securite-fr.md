---
description: Revue de sécurité. Utilisez cette commande pour exécuter la revue correspondante.
argument-hint: [zone du projet ou préoccupation]
---

Utilisez la compétence canonique `security-privacy-reliability` pour le projet actuel.
